...
(function () {
  ...
  const SHARED_KEYS = {
    ...
    // بيانات الدورات الحضورية (تاريخ/مكان/مدرب/حضور): كانت st.set تسقط في default
    // فلا تُحفظ وتُمحى عند مغادرة التبويب. نمرّرها عبر الإعدادات لتُخزَّن على الخادم.
    intcourses_360c: 'intcourses',
    // قاموس الترجمة الإنجليزية (ثنائية اللغة): عربي → إنجليزي، يديره مدير النظام
    i18n_360c: 'i18n',
  };
